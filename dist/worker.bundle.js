// Worker Bundle - Built 2026-08-26T18:03:45Z
// Version: 0.0.0
...
async function executeTool(c, name, args) {
  ...
  switch (name) {
    ...
    case "update_product": {
      const payload = {};
      if (a.name !== void 0) payload.name = a.name;
      if (a.price !== void 0) payload.price = Number(a.price);
      if (a.description !== void 0) payload.description = a.description;
      if (a.imageUrl !== void 0) payload.imageUrl = a.imageUrl;
      if (Array.isArray(a.images)) payload.images = a.images.filter(Boolean);
      if (a.collectionId !== void 0) payload.collectionId = a.collectionId;
      const r = await dispatch(c, `/api/admin/products/${encodeURIComponent(a.id)}`, {
        method: "PUT",
...
async function executePageTool(c, name, args) {
  ...
  if (name === "get_page") {
    const r2 = await dispatch(c, `/api/admin/storefront/pages/${encodeURIComponent(slug)}`);
  ...
  if (name === "create_page") {
    const r2 = await dispatch(c, "/api/admin/storefront/pages", {
      method: "POST",
...
router17.post("/chat", asyncHandler(async (c) => {
  ...
  for (let i = 0; i < MAX_TOOL_ITERATIONS; i++) {
    ...
    for (const call of toolCalls) {
      ...
      try {
        const result = name === "get_page" || name === "create_page" || name === "update_page" ? await executePageTool(c, name, args) : await executeTool(c, name, args);
