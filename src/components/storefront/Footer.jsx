  ...
  return (
    <footer className="bg-slate-50 border-t border-slate-200">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-32 md:h-24">
          ...
          <div className="flex flex-col justify-center items-center text-center space-y-2 md:col-span-1">
            ...
            <a
              ...
              className="inline-flex items-center px-4 py-2 border border-slate-300 rounded-md shadow-sm text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 hover:border-purple-300 hover:text-purple-600 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
            >
        ...
        {/* Bottom section */}
        <div className="mt-6 pt-4 md:mt-3 md:pt-3 border-t border-slate-200">
