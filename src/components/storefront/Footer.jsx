        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-32 md:h-24">
          ...
          <div className="flex flex-col justify-center items-center text-center space-y-2 md:col-span-1">
            ...
            <a
              ...
              className="inline-flex items-center px-4 py-2 border border-slate-300 rounded-md shadow-sm text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 hover:border-slate-300 hover:text-slate-600 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500"
            >
